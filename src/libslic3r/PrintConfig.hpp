...
enum PrintHostType {
   htPrusaLink, htPrusaConnect, htOctoPrint, htMoonraker, htDuet, htFlashAir, htAstroBox, htRepetier, htMKS, htPrusaConnectNew, htBambuLan
};
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,               external_inward_scarf_exit_distance))
    ((ConfigOptionPercent,             external_inward_scarf_end_flow))
    ((ConfigOptionBool,                external_inward_scarf_exit))
    ((ConfigOptionBool,                external_inward_scarf_retract))
    ((ConfigOptionFloat,               external_inward_scarf_taper_length))
    ((ConfigOptionBool,                internal_brick_seam_tuck))
    ((ConfigOptionPercent,             internal_brick_seam_tuck_flow))
    ((ConfigOptionFloat,               internal_brick_seam_tuck_overlap))
    ((ConfigOptionBool,                internal_brick_seam_tuck_retract))
    ((ConfigOptionFloat,               internal_brick_seam_tuck_wipe_distance))
    ((ConfigOptionFloat,               internal_brick_seam_tuck_z_dip))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionBool,               wipe_tower_arrange))
