...
static std::vector<std::string> s_Preset_print_options {
    ...
    "external_inward_scarf_exit", "external_inward_scarf_taper_length", "external_inward_scarf_end_flow",
    "external_inward_scarf_exit_distance", "external_inward_scarf_retract",
    ...
    "wipe_tower",
    "wipe_tower_width", "wipe_tower_depth", "wipe_tower_arrange", "wipe_tower_cone_angle", "wipe_tower_brim_width", "wipe_tower_bridging", "single_extruder_multi_material_priming", "mmu_segmented_region_max_width",
