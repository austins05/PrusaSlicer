...
Plater::priv::priv(Plater* q, MainFrame* main_frame)
    ...
    , config(Slic3r::DynamicPrintConfig::new_from_defaults_keys({
        ...
        "wipe_tower", "wipe_tower_arrange", "wipe_tower_width", "wipe_tower_depth", "wipe_tower_brim_width", "wipe_tower_cone_angle", "wipe_tower_extra_spacing", "wipe_tower_extra_flow", "wipe_tower_extruder",
